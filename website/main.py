...
def on_message_received(topic, payload, dup, qos, retain, **kwargs):
    ...
    with open("./data/img.jpg", 'wb') as f:
        print("Received image, num:{}".format(j["state"]["desired"]["imageNum"]))
        imgdata=j["state"]["desired"]["image"]
        imgs=imgdata.split(',')[1]
        bytesdata=bytes(imgs, 'utf-8')
        f.write(base64.decodebytes(bytesdata))    
